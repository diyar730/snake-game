...
export default function Game() {
  ...
  const [gameConstant, setGameConstans] = useState({
    gridCellHeight: 20,
    gridCellWidth: 20,
  });
...
let emptyRows = [] 
emptyRows = () => [...Array(gameConstant.gridCellWidth)].map((e, x) => [...Array(gameConstant.gridCellHeight)].map((r, y) => {return {x:x, y:y}} ));
